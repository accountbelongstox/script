...
packages=("lsof" "yum-utils" "device-mapper-persistent-data" "lvm2" "iputils" "yum-utils" "cronie" "device-mapper-persistent-data" "lvm2" "rsync" "nano" "wget" "curl" "vim" "alternatives" "gcc-c++" "make")
