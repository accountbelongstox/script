...
class Screen(Base):
    ...
    def __init__(self, capture_interval=60):
        ...
        self.default_dir = os.path.join(self.get_root_dir(), "out/screen")
        self.mkdir(self.default_dir)
    ...
    def capture_screen(self, screen_name="full_screen",info=False):
    ...
    def start_capture_screen(self, ):
        if self.isFile(self.default_dir) == None or self.current_screen_file == None:
            self.capture_screen()
