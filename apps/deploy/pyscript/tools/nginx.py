...
class Nginx(Base):
    ...
    def replace_wwwroot(self, content):
        ...
        content = content.replace("/www/debian12/nginx/proxy_temp_dir", "/home/tmp/proxy_temp_dir")
        content = content.replace("/www/debian12/nginx/proxy_cache_dir", "/home/tmp/proxy_cache_dir")
